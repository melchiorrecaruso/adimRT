...
var
  ...
  procedure LoadA;
  begin A.Init(3, TArrayOfDouble.Create(1,2,3, 4,5,6, 7,8,10)); end;

  // B = [[2,0,1],[1,3,0],[0,1,2]]
  procedure LoadB;
  begin B.Init(3, TArrayOfDouble.Create(2,0,1, 1,3,0, 0,1,2)); end;
...
begin
  ...
  C_mat.Init(3, TArrayOfDouble.Create(1,2,3, 2,4,6, 3,6,9));
  ...
  Res := A.Reciprocal(A.Determinant);
  ...
  // 2x2 case
  A.Init(2, TArrayOfDouble.Create(3,1, 2,4));
  CheckNear('det([[3,1],[2,4]]) = 10', A.Determinant, 10.0, EPS);
  Res := A.Reciprocal(10.0);
  ...
  A.Init(3, TArrayOfDouble.Create(2,1,-1, 4,3,1, 2,2,3));
  Res := A.RowReduction;
  ...
  A.Init(3, TArrayOfDouble.Create(4,2,1, 2,5,3, 1,3,6));
  eigs := A.Eigenvalues;
  SortAscArray(eigs);
  ...
  A.Init(4, TArrayOfDouble.Create(5,1,0,2, 1,4,1,0, 0,1,3,1, 2,0,1,6));
  eigs := A.Eigenvalues;
  SortAscArray(eigs);
  ...
  A.Init(3, TArrayOfDouble.Create(3,0,0, 0,1,0, 0,0,5));
  eigs := A.Eigenvalues;
  SortAscArray(eigs);
  ...
  A.Init(2, TArrayOfDouble.Create(1,2, 3,4));
  A.Swap(0,1);
...
begin
  ...
  M3.Init(3, TArrayOfDouble.Create(2,-1,0, -1,2,-1, 0,-1,2));
  // M4 SPD-ish
  M4.Init(4, TArrayOfDouble.Create(4,1,2,0.5, 1,3,0,1, 2,0,5,1, 0.5,1,1,4));
  // G3 general non-symmetric
  G3.Init(3, TArrayOfDouble.Create(3,2,-1, 2,-2,4, -1,0.5,-1));
  // H4 Hilbert 4x4 (ill-conditioned)
  H4.Init(4, TArrayOfDouble.Create(
    1, 1/2, 1/3, 1/4,
    1/2, 1/3, 1/4, 1/5,
    1/3, 1/4, 1/5, 1/6,
    1/4, 1/5, 1/6, 1/7));
  ...
  Inv := M3.Reciprocal(M3.Determinant);
  ...
  Inv := M4.Reciprocal(M4.Determinant);
  ...
  Inv := H4.Reciprocal(H4.Determinant);
  ...
  ev := G3.Eigenvalues;  // general matrix, real spectrum not guaranteed but trace check ok
  // numpy: trace(G3)=0; if eigenvalues real their sum must equal trace
  // (G3 happens to have one real + complex pair, so skip; use M4)
  ev := M4.Eigenvalues;
  ...
  S5.Init(5, TArrayOfDouble.Create(
  ...
  D5.Init(5, TArrayOfDouble.Create(
...
begin
  ...
  M.Init(5, TArrayOfDouble.Create(
  ...
  Inv := M.Reciprocal(M.Determinant);
  ...
  M.Init(6, TArrayOfDouble.Create(
  ...
  M.Init(7, TArrayOfDouble.Create(
  ...
  M.Init(8, TArrayOfDouble.Create(
...
begin
  ...
  ev := M.Eigenvalues; SortAscArray(ev);
  ...
  M.Init(9, TArrayOfDouble.Create(
  ...
  M.Init(10, TArrayOfDouble.Create(
...
begin
  ...
  A.Init(5, TArrayOfDouble.Create(
  ...
  B.Init(5, TArrayOfDouble.Create(
  ...
  A.Init(6, TArrayOfDouble.Create(
  ...
  B.Init(6, TArrayOfDouble.Create(
  ...
  A.Init(7, TArrayOfDouble.Create(
  ...
  B.Init(7, TArrayOfDouble.Create(
  ...
  A.Init(8, TArrayOfDouble.Create(
  ...
  B.Init(8, TArrayOfDouble.Create(
